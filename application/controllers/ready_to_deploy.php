...
class Ready_to_deploy extends CI_Controller 
{
   ...
   function view_ready_to_deploy()
    { 
         $data['load_ready_asset']= $this->Asset_model->display_assets();
         $data['main_content'] ='Ready_to_deploy/view_ready_to_deploy';
         $this->load->view('includes/template', $data);  
  }
  function new_asset()
    { 
         $data['main_content'] ='Ready_to_deploy/add_ready_asset';
         $this->load->view('includes/template', $data);  
  }
function add_asset()
     {
...
//$this->form_validation->set_rules('Order_no', 'Order No',  'required|numeric');
    ...
    else
    {
      ...
      //TODO: store in db an show notification
       ...
       //TODO: refresh page
       redirect('ready_to_deploy/new_asset','refresh');
