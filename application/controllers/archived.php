...
class Archived extends CI_Controller 
{
   ...
   function view_archived()
    { 
         ...
         $data['main_content'] ='archived_assets/view_archived';
         $this->load->view('includes/template', $data);  
  }
  function new_archived_asset()
  { 
         $data['main_content'] ='archived_assets/new_archived_asset';
         $this->load->view('includes/template', $data);  
  }
function add_archived_asset()
     {
       //TODO: parse the info
...
//$this->form_validation->set_rules('Order_no', 'Order No',  'required|numeric');
    ...
    else
    {
      ...
      //TODO: store in db an show notification
       ...
       //TODO: refresh page
       redirect('archived/new_archived_asset','refresh');
