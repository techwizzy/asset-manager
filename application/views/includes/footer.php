	...
	<script type="text/javascript" language="javascript" src="<?php echo base_url();?>assets/TableTools/js/dataTables.tableTools.js"></script>
	<script type="text/javascript" language="javascript" src="<?php echo base_url();?>assets/examples/resources/syntax/shCore.js"></script>
	<script type="text/javascript" language="javascript" src="<?php echo base_url();?>assets/examples/resources/demo.js"></script>
...
$(document).ready(function() {
    ...
    ('#load').click(function () {
    // Adding loading GIF
    $('#content').html('<img src="<?php echo base_url();?>assets/img/ajax-loaders/ajax-loader-6.gif"" width="100" height="100" align="center" />');
...
$(document).ready(function(){
	...
	{
		$('#bs-css').attr('href','<?php echo base_url();?>assets/css/bootstrap-'+theme_name+'.css');
	}
...
function docReady(){
	...
	$('#file_upload').uploadify({
		'swf'      : '<?php echo base_url();?>assets/misc/uploadify.swf',
		'uploader' : '<?php echo base_url();?>assets/misc/uploadify.php'
