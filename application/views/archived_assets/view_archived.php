			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="#">Archived Assets</a>
					</li>
				</ul>
			</div>
		    <div  style=" float: right;right: 0px;">
				<a class="btn btn-success " href="<?php echo base_url();?>index.php/archived/new_archived_asset"><span><i class="icon-plus icon-white"></i> </span>Create new Asset</a>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-list"></i>Archived Assets </h2><span style=" float: right;right: 0px;"><button class="btn btn-default">Print</button><button  class="btn btn-default" >Export</button></span>
